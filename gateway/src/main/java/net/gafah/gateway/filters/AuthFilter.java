package net.gafah.gateway.filters;
...
import net.gafah.gateway.dtos.TokenDto;
...
public class AuthFilter implements GatewayFilter {
    ...
    private static final String AUTH_VALIDATE_URI = "http://localhost:3001/auth-server/auth/jwt";
